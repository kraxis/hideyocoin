...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "HideYoCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"hideyocointools.com", "dnsseed.hideyocointools.com"},
    {"hideyocoinpool.org", "dnsseed.hideyocoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"hideyocointools.com", "testnet-seed.hideyocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. HideYoCoin is probably already running."), addrBind.ToString().c_str());
        else
